...
export const SignUpForm = () => {
  ...
  // The success path returns ok({ redirectTo, rateLimit }) instead of redirect()ing
  // server-side — the form navigates here. typedRoutes brands `Route`, so the
  // runtime-string redirectTo is cast at this one site.
  useEffect(() => {
    if (state?.ok === true) {
