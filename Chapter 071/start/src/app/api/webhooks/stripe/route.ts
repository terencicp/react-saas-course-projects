...
export const POST = async (request: Request): Promise<Response> => {
  ...
  // TODO(L4) — past-due path: onSubscriptionUpdated collects owner ids inside the tx into a closure array; route.ts dispatches org.billing.past_due after db.transaction commits
  let duplicate = false;
