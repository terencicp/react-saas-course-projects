...
// resolves its table.
// TODO(L3) — spread the audit schema here (`import * as auditSchema from './audit'`)
// so db.query.auditLogs resolves, and export a `Transaction` type
// (Parameters<Parameters<typeof db.transaction>[0]>[0]) that withTenant + logAudit
// import.
