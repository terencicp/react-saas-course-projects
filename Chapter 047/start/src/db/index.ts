...
// Relations v1: the *Relations consts are spread INTO the schema object (there
// is no separate `relations` option on 0.45 — that is the Drizzle 1.0 shape).
// This wires db.query.<table> with the relation graph.
