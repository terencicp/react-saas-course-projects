...
import { switchUserAction } from '@/app/(protected)/inspector/actions';
import {
  Select,
  SelectContent,
  SelectItem,
...
export const ActingUserSwitcher = ({
  ...
  const [, formAction] = useActionState(switchUserAction, null);

  return (
    <form action={formAction} data-testid="acting-user-switcher">
      <Select
        name="userId"
