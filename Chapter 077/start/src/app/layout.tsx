...
// TODO(L2) — wrap children in <Providers>
//
// `<Providers>` already wraps `{children}` below; the TanStack wiring lands
// inside `providers.tsx` (the QueryClientProvider + devtools), so this layout
// needs no further edit once that file is built.
